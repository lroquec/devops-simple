...
class FlaskLoginTests(unittest.TestCase):
    ...
    def test_login_post_success(self):
        self.configure_mock_cursor(fetchone_return={
            'id': 1,
            'username': 'testuser',
    ...
    def test_register_post_success(self):
        ...
        response = self.app.post('/login/register', data={
            'username': 'newuser',
            'password': 'newpass',
            'email': 'test@test.com'
        })
    ...
    def test_register_post_existing_account(self):
        self.configure_mock_cursor(fetchone_return={'id': 1, 'username': 'existinguser'})
    ...
    def test_register_hashing(self):
        with self.app as c:
            ...
            response = c.post('/login/register', data={
                'username': username,
                'password': password,
                'email': email
            }, follow_redirects=True)
